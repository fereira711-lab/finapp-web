    ...
    <AppShell>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-primary hover:bg-primary-dark text-white text-sm px-4 py-2 rounded-lg transition-colors"
        >
          <Plus size={16} />
          Nova Conta
        </button>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="bg-dark-800 rounded-xl p-4 border border-dark-700">
          ...
          <p className="text-xl font-bold text-red-400">{formatCurrency(totalPayable)}</p>
        </div>
        <div className="bg-dark-800 rounded-xl p-4 border border-dark-700">
          <p className="text-xs text-gray-400 mb-1">Pendente a receber</p>
          <p className="text-xl font-bold text-green-400">{formatCurrency(totalReceivable)}</p>
        </div>
      </div>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <form
            onSubmit={handleAdd}
            className="relative bg-dark-800 rounded-2xl p-6 border border-dark-700 w-full max-w-md space-y-4 shadow-2xl"
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-dark-900 border border-dark-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary"
              ...
              <div className="flex items-end pb-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-dark-700 bg-dark-900 text-primary focus:ring-primary"
                  />
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-dark-900 border border-dark-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary resize-none"
            ...
            <button
              type="submit"
              disabled={saving}
              className="w-full bg-primary hover:bg-primary-dark text-white text-sm font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50"
            >
